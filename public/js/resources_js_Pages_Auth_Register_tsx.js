(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_Pages_Auth_Register_tsx"],{
...
var Register = function Register(_a) {
  var jetstream = _a.jetstream;
  ...
  return react_1["default"].createElement("form", {
  ...
  }, react_1["default"].createElement("div", null, react_1["default"].createElement("label", null, "Name:"), react_1["default"].createElement("input", {
    type: "text",
    value: data.name,
    name: "name",
    onChange: handleChange
  }), errors.name && react_1["default"].createElement("div", null, errors.name)), react_1["default"].createElement("div", null, react_1["default"].createElement("label", null, "E-mail:"), react_1["default"].createElement("input", {
    type: "text",
    value: data.email,
    name: "email",
    onChange: handleChange
    ...
    name: "password",
    onChange: handleChange
  }), errors.password && react_1["default"].createElement("div", null, errors.password)), react_1["default"].createElement("div", null, react_1["default"].createElement("label", null, "Conform password"), react_1["default"].createElement("input", {
    type: "password",
    value: data.password_confirmation,
    name: "password_confirmation",
    onChange: handleChange
  }), errors.password_confirmation && react_1["default"].createElement("div", null, errors.password_confirmation)), jetstream.hasTermsAndPrivacyPolicyFeature && react_1["default"].createElement("div", null, react_1["default"].createElement("input", {
    type: "checkbox",
    checked: data.terms,
    name: "terms",
    onChange: handleChange
    ...
    target: "_blank",
    href: ziggy_js_1["default"]("terms.show")
  }, "Terms of Service"), " ", "and", " ", react_1["default"].createElement("a", {
    target: "_blank",
    href: ziggy_js_1["default"]("policy.show")
  }, "Privacy Policy")), react_1["default"].createElement("div", null, react_1["default"].createElement("button", {
    type: "submit",
    disabled: processing
  }, "Register")));
};
